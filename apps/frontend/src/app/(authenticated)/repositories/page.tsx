        ...
        <div className="w-full sm:w-auto">
          <div className="relative">
            ...
            <input
              ...
              className="w-full sm:w-80 pl-10 pr-4 py-3 border border-gray-300 rounded-xl shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 bg-white/50 backdrop-blur-sm"
            />
          </div>
        </div>
      </div>
